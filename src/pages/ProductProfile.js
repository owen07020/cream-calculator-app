...
function ProductProfile({ onSave }) {
  ...
  const saveProfile = () => {
    ...
    const savedProfiles = JSON.parse(localStorage.getItem('productProfiles') || '[]');
    const updatedProfiles = [...savedProfiles, { productName, components }];
    localStorage.setItem('productProfiles', JSON.stringify(updatedProfiles));
